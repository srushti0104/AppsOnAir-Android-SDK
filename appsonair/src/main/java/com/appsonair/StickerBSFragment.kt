...
class StickerBSFragment : BottomSheetDialogFragment() {
    ...
    override fun setupDialog(dialog: Dialog, style: Int) {
        ...
        val stickerSize = resources.getStringArray(R.array.sticker_paths).size
        rvEmoji.adapter = stickerAdapter
        rvEmoji.setHasFixedSize(true)
        rvEmoji.setItemViewCacheSize(stickerSize)
    }
    ...
    inner class StickerAdapter : RecyclerView.Adapter<StickerAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val stickerPath = getStickerPaths()[position]
        ...
        override fun getItemCount(): Int {
            return getStickerPaths().size
        }

        private fun getStickerPaths(): Array<String> {
            return resources.getStringArray(R.array.sticker_paths)
        }
            ...
            init {
                itemView.setOnClickListener {
                    if (mStickerListener != null) {
                        val stickerPath = getStickerPaths()[layoutPosition]
                        Glide.with(requireContext())
                            .asBitmap()
                            .load(stickerPath)
